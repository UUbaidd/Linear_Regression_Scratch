...
where X is features , $${\mu}$$ is mean. $${\sigma}$$ is sign of standard deviation . We use $${\epsilon}$$ to avoid NAN, becuase if SD becomes 0 then this will not work without epsilon.
